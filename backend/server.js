...
// Endpoint pour compter le nombre d'éducations par genre
// app.get("/countByGender", async (req, res) => {
//   try {
//     const countByGender = await EducationModel.aggregate([
//       { $group: { _id: "$gender", count: { $sum: 1 } } }
//     ]);
//     res.json(countByGender);
//   } catch (error) {
//     console.error("Error counting educations by gender:", error.message);
//     res.status(500).send("Server error while counting educations by gender");
//   }
// });
